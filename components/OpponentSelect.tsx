    ...
    <div className="absolute inset-0 bg-slate-950 flex flex-col items-center justify-center p-8 z-50">
      ...
      <div className="grid grid-cols-3 gap-6 max-w-5xl w-full">
          ...
          <div className="col-span-2 grid grid-cols-4 gap-4">
              {renderCard("火焰球", CharacterType.PYRO, "red", "🔥")}
              {renderCard("坦克球", CharacterType.TANK, "emerald", "🛡️")}
              {renderCard("悟空球", CharacterType.WUKONG, "yellow", "🐵")}
              {renderCard("猫猫球", CharacterType.CAT, "amber", "🐱")}
          </div>
